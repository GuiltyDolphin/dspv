...
testGroup("parseAsOrThrow",
    ...
    testGroup("special specs",
        ...
        testGroup("Enum",
            testGroup('[Enum, "test", 7]',
                testParseAsOrThrow('"test" (in enum)', '"test"', [Enum, "test", 7], "test"),
                testParseAsOrThrow('7 (in enum)', '7', [Enum, "test", 7], 7),
                assertParseFailsWithTypeError('"test2" (not in enum)', basicParser, '"test2"', [Enum, "test", 7], [Enum, "test", 7], "different value", "test2"),
                assertParseFailsWithTypeError('1 (not in enum)', basicParser, '1', [Enum, "test", 7], [Enum, "test", 7], "different value", 1),
            ),
            testGroup('[Enum]',
                assertParseFailsWithTypeError('"test" (not in enum - nothing is in empty enum)', basicParser, '"test"', [Enum], [Enum], "different value", "test"),
            ),
        ),
